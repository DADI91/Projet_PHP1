<!DOCTYPE html>
 ...
 <body  class="p-3 mb-2 text-white">
    ...
    while($ligne = mysqli_fetch_array($reponse1)){
        ...
        echo "<tr >";
        echo "<td>Titre : ".$ligne['Contenue']."</td>";
        echo "<td>Jusqu'au : ".$ligne['Auteur']."</td>";
        echo "<td>Durée : ".$ligne['Date']."h</td>";
        echo "</tr>";
        
        echo "<tr>";
        echo "<td>Tarif : ".$ligne['TARIFANIM']." </td>";
        echo "<td>Age minimun : ".$ligne['LIMITEAGE']."</td>";
        echo "<td>Nombre de place : ".$ligne['NBREPLACEANIM']."</td>";
        echo "</tr></br>";
        
        echo "<tr>";
        echo "<td colspan=25% ><a colspan=3 href='Consulter_Activiter.php?cd_Anime=".$ligne['CODEANIM']."'>Voir Activité</a></td>";
        echo "</tr></br>";
